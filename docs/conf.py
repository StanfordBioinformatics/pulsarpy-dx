...
htmlhelp_basename = 'pulsarpy-dxdoc'
...
latex_documents = [
    (master_doc, 'pulsarpy-dx.tex', 'pulsarpy-dx Documentation',
...
man_pages = [
    (master_doc, 'pulsarpy-dx', 'pulsarpy-dx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pulsarpy-dx', 'pulsarpy-dx Documentation',
     author, 'pulsarpy-dx', 'One line description of project.',
     'Miscellaneous'),
]
